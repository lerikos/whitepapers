...
class PapersControllerTest < ActionController::TestCase
  ...
  test "should create paper" do
    assert_difference('Paper.count') do
      post :create, paper: { publisher: @paper.publisher, summary: @paper.summary, title: @paper.title, url: @paper.url }
    end
  ...
  test "should update paper" do
    patch :update, id: @paper, paper: { publisher: @paper.publisher, summary: @paper.summary, title: @paper.title, url: @paper.url }
    assert_redirected_to paper_path(assigns(:paper))
  end
